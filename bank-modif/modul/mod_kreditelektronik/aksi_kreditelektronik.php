...
// Hapus servis
if ($module=='pinjamanelektronik' AND $act=='hapus'){
  //mysql_query("DELETE FROM pinjaman WHERE id_pinjaman='$_GET[id]'");
  header('location:../../media.php?module='.$module);
}

// Input pinjaman
if ($module=='kreditelektronik' AND $act=='input'){
	...
	Lama Pinjaman: $_GET[tenor] <br/>
	Jumlah Pinjaman: $_GET[pinjaman] <br/>
	";
	...
	*/
	$tanggal=date("Y-m-d");
			...
			mysqli_query($koneksi, "INSERT INTO pinjamanelektronik(
			kd_barang,
											nik,
											tgl_pengajuan, 
											pinjaman, 
	...
	header("location:../../media.php?module=pinjamanelektronik");	
}
