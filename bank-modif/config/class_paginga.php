...
// Fungsi untuk mencek halaman dan posisi data
function cariPosisi($batas){
if(empty($_GET['halmentor'])){
$posisi=0;
$_GET['halmentor']=1;
}
else{
$posisi = ($_GET['halmentor']-1) * $batas;
}
return $posisi;
}
...
if($halaman_aktif > 1){
$prev = $halaman_aktif-1;
$link_halaman .= "<a href=halmentor-1.html class='nextprev'><< First</a>
                  <a href=halmentor-$prev.html class='nextprev'>< Prev</a>";
}
else{
$link_halaman .= "<span class='nextprev'><< First</span><span class='nextprev'>< Prev </span> ";
}
...
if ($i < 1)
continue;
$angka .= "<a href=halmentor-$i.html>$i</a>  ";
}
$angka .= " <span class='current'><b>$halaman_aktif</b></span>";
...
$angka .= ($halaman_aktif+2<$jmlhalaman ? "<span class='nextprev'>...</span><a href=halmentor-$jmlhalaman.html>$jmlhalaman</a> " : " ");
...
if($halaman_aktif < $jmlhalaman){
$next = $halaman_aktif+1;
$link_halaman .= " <a href=halmentor-$next.html class='nextprev'>Next ></a>
<a href=halmentor-$jmlhalaman.html class='nextprev'>Last >></a> ";
}
else{
$link_halaman .= " <span class='nextprev'>Next ></span> <span class='nextprev'> Last >></span>";
}
...
if($halaman_aktif > 1){
$prev = $halaman_aktif-1;
$link_halaman .= "<a href=halevent-1.html class='nextprev'><< First</a>
                  <a href=halevent-$prev.html class='nextprev'>< Prev</a>";
}
else{
$link_halaman .= "<span class='nextprev'><< First</span><span class='nextprev'>< Prev </span> ";
}
...
if ($i < 1)
continue;
$angka .= "<a href=halevent-$i.html>$i</a>  ";
}
$angka .= " <span class='current'><b>$halaman_aktif</b></span>";
...
$angka .= ($halaman_aktif+2<$jmlhalaman ? "<span class='nextprev'>...</span><a href=halevent-$jmlhalaman.html>$jmlhalaman</a> " : " ");
...
if($halaman_aktif < $jmlhalaman){
$next = $halaman_aktif+1;
$link_halaman .= " <a href=halevent-$next.html class='nextprev'>Next ></a>
<a href=halevent-$jmlhalaman.html class='nextprev'>Last >></a> ";
}
else{
$link_halaman .= " <span class='nextprev'>Next ></span> <span class='nextprev'> Last >></span>";
}
...
// Fungsi untuk mencek halaman dan posisi data
function cariPosisi($batas){
if(empty($_GET['halbisnis'])){
$posisi=0;
$_GET['halbisnis']=1;
}
else{
$posisi = ($_GET['halbisnis']-1) * $batas;
}
return $posisi;
}
...
if($halaman_aktif > 1){
$prev = $halaman_aktif-1;
$link_halaman .= "<a href=halbisnis-1.html class='nextprev'><< First</a>
                  <a href=halbisnis-$prev.html class='nextprev'>< Prev</a>";
}
else{
$link_halaman .= "<span class='nextprev'><< First</span><span class='nextprev'>< Prev </span> ";
}
...
if ($i < 1)
continue;
$angka .= "<a href=halbisnis-$i.html>$i</a>  ";
}
$angka .= " <span class='current'><b>$halaman_aktif</b></span>";
...
$angka .= ($halaman_aktif+2<$jmlhalaman ? "<span class='nextprev'>...</span><a href=halbisnis-$jmlhalaman.html>$jmlhalaman</a> " : " ");
...
if($halaman_aktif < $jmlhalaman){
$next = $halaman_aktif+1;
$link_halaman .= " <a href=halbisnis-$next.html class='nextprev'>Next ></a>
<a href=halbisnis-$jmlhalaman.html class='nextprev'>Last >></a> ";
}
else{
$link_halaman .= " <span class='nextprev'>Next ></span> <span class='nextprev'> Last >></span>";
}
...
if($halaman_aktif > 1){
	$prev = $halaman_aktif-1;
	$link_halaman .= "<a href=haltestimoni-1.html><< First</a> | 
                    <a href=haltestimoni-$prev.html>< Prev</a> | ";
}
else{ 
	$link_halaman .= "<< First | < Prev | ";
}
...
for ($i=$halaman_aktif-2; $i<$halaman_aktif; $i++){
  if ($i < 1)
  	continue;
	  $angka .= "<a href=haltestimoni-$i.html>$i</a> | ";
  }
	  $angka .= " <b>$halaman_aktif</b> | ";
    ...
    if($i > $jmlhalaman)
	  ...
	  $angka .= ($halaman_aktif+2<$jmlhalaman ? " ... | <a href=haltestimoni-$jmlhalaman.html>$jmlhalaman</a> | " : " ");
...
if($halaman_aktif < $jmlhalaman){
	$next = $halaman_aktif+1;
	$link_halaman .= " <a href=haltestimoni-$next.html>Next ></a> | 
                     <a href=haltestimoni-$jmlhalaman.html>Last >></a> ";
}
else{
	$link_halaman .= " Next > | Last >>";
}
